...
interface ReviewCardProps {
  avatar: any; // Replace 'any' with the specific type for avatar source if available
  name: string;
  description: string;
  avgRating: number; // or string, depending on how avgRating is used
  date: string; // or Date if it's a Date object
  numLikes: number; // or string if it can be a string
}
