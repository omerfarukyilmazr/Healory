        ...
        <View style={styles.headerRight}>
          <TouchableOpacity>
            <Image
              ...
              resizeMode="contain"
              style={[styles.searchIcon, { tintColor: dark ? COLORS.secondaryWhite : COLORS.greyscale900 }]}
            />
          </TouchableOpacity>
          ...
          renderItem={({ item }) => (
            <TouchableOpacity>
              <View style={styles.articleContainer}>
                ...
                <Text style={[styles.articleTitle, { color: dark ? COLORS.white : COLORS.greyscale900 }]}>
